...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../answer.test-samples';

import { AnswerService, RestAnswer } from './answer.service';

const requireRestSample: RestAnswer = {
