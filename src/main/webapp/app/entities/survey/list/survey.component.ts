...
import { EntityArrayResponseType, SurveyService } from '../service/survey.service';
...
export class SurveyComponent implements OnInit {
  ...
  protected readonly surveyService = inject(SurveyService);
  ...
  trackId = (item: ISurvey): number => this.surveyService.getSurveyIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.surveys.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: ISurvey[] | null): ISurvey[] {
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.surveyService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
